...
> Fill the two placeholders once the frontend deploy finishes and you record the video:
> `https://chartpilot-frontend-zkhsg5lcca-el.a.run.app` and `⟨VIDEO_URL⟩`. Everything else is ready to paste into Devpost.
...
- **Live demo (frontend):** https://chartpilot-frontend-zkhsg5lcca-el.a.run.app   ← *filled once the frontend Cloud Run deploy completes*
...
2. [ ] **Paste `https://chartpilot-frontend-zkhsg5lcca-el.a.run.app`** (from the frontend deploy — I'll give it to you) into the live-demo field.
